...
public class QtdwActivity extends BaseActivity implements OnClickListener
{
	private QTDW attrs;
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(R.layout.activity_qtdw);
		initData();
		initView();
	}
	...
	private void initData()
	{
		...
		attrs = (QTDW) getIntent().getSerializableExtra("attrs");
		if (attrs.ID == null)
		{
			isEdit = false;
		}
				...
				DictDialogUtil.changeType(this, new MapDictCallback()
				{
					...
					public void call(MapLevelDictObject mapLevelDictObject)
					{
						TypeUtil.changeType(mapLevelDictObject, attrs,
								QtdwActivity.this, WAIT_FOR_RESULT);
					}
				});
			}
			break;
