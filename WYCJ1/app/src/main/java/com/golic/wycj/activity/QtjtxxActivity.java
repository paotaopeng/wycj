...
public class QtjtxxActivity extends BaseActivity implements OnClickListener
{
	private QTJTXX attrs;
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(R.layout.activity_qtjtxx);
		initData();
		initView();
	}
	...
	private void initData()
	{
		...
		attrs = (QTJTXX) getIntent().getSerializableExtra("attrs");
		if (attrs.ID == null)
		{
			isEdit = false;
		}
	...
	public void onClick(View v)
	{
				...
				DictDialogUtil.changeType(this, new MapDictCallback()
				{
					...
					public void call(MapLevelDictObject mapLevelDictObject)
					{
						TypeUtil.changeType(mapLevelDictObject, attrs,
								QtjtxxActivity.this, WAIT_FOR_RESULT);
					}
				});
			}
			break;
		...
		case R.id.bt_take_photo:
			...
			break;
		case R.id.bt_save:
			String name = input_name.getShowView().getText().toString().trim();
			...
			else
			{
				...
				else
				{
					...
					attrs.fillDjxx();
					fillBean(name, zname, bz);
					// ChechUtil.addcheck(this, attrs, analyseEngine,
					// ywzyDaoImpl,
					// ggsjDaoImpl);
